...
@ResponseBody
public Fenye<Network_trace> SelectNetworkTrace(Network_trace network_trace ,Integer page,Integer rows){
	Users user=counselorService.selectUsersInfo(network_trace.getUid());
	//查询咨询师id
	Ask ask =counselorService.selectAskInfo(user.getLonginName());
...
@ResponseBody
public Fenye<Network_trace> SeleteNetwork_traceLog(Network_trace network_trace ,Integer page,Integer rows){
