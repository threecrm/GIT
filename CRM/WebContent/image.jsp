...
<body>
     <table>
     	<tr>
     		<td><span id="container" style="min-width:400px;height:400px"></span></td>
     		<td><span id="container1" style="min-width:400px;height:400px"></span></td>
     	</tr>
     </table>
        ...
        function personage(){
        	$.post("getHigcharts",function(data){
       		 var zt=data.zt;
       		 var zc=data.zc;
       		 var cd=data.cd;
