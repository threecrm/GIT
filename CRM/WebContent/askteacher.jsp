...
function formatterSet(value,row,index){
	   ...
	   +" <a href='javascrip:void(0)'  onclick='Lookaskteacher("+index+")'>网络学生</a> "	   
} 
//查看网络学生
 function Lookaskteacher(index){
	 var date=$("#tabask").datagrid("getData");
 ...
 function update(index){
	var data = $("#tabask").datagrid("getData");
...
<body>
   <table id="tabask" class="easyui-datagrid">
  <thead>
       <tr>
