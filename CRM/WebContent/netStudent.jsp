...
<script type="text/javascript"
	...
	return "<a href='javascrip:void(0)' onclick='look(" + index
			+ ")'>查看</a>  <a href='javascrip:void(0)' onclick='updateNetStudent(" + index
			+ ")'>修改 </a>   <a href='javascrip:void(0)'  onclick='updateShixiao(" + index
			+ ")'>失效</a>  "
}
	function init(){
	...
	function addtrue() {
		$.post("addNetStudent", {
			...
			IsValid:    $("#addIsValid").combobox("getValue"),
...
<body>
 ...
 <input type="hidden" id="LoginUserName" value="${LoginUserName}">	<!--获取登陆者姓名  --> 
  <input type="hidden" id="uid" value="${uid}"><!--获取登陆者id  --> 
 <div id="seachId">
		<table>
			<tr>
  ...
  <!-- 动态显示 -->
	<div id="dtcx_students" class="easyui-dialog" title="设置要显示的列" data-options="modal:true,closed:true,iconCls:'icon-save'" style="width:500px;height:200px;padding:10px;">
		<table>
			<tr>
				<td><input checked="checked" type="checkbox" onclick="checkOrCloseAll(this)" /></td>
				<td>全选</td>
			</tr>
			<tr>											
				<td><input class="checkeds" checked="checked" type="checkbox" name="sid" onclick="checkOrClose(this)" /></td><td>学生编号</td>
				<td><input class="checkeds" checked="checked" type="checkbox" name="sname" onclick="checkOrClose(this)" /></td><td>姓名 </td>
				<td><input class="checkeds" checked="checked" type="checkbox" name="age" onclick="checkOrClose(this)" /></td><td>年龄</td>			
				<td><input class="checkeds" checked="checked" type="checkbox" name="sex" onclick="checkOrClose(this)" /></td><td>性别</td>
			</tr>
			<tr>
				<td><input class="checkeds" checked="checked" type="checkbox" name="phone" onclick="checkOrClose(this)" /></td><td>电话 </td>
				<td><input class="checkeds" checked="checked" type="checkbox" name="stuStatus" onclick="checkOrClose(this)" /></td><td>学生状态 </td>
				<td><input class="checkeds" checked="checked" type="checkbox" name="perStatus" onclick="checkOrClose(this)" /></td><td>个人状态 </td>										
				<td><input class="checkeds" checked="checked" type="checkbox" name="msgSource" onclick="checkOrClose(this)" /></td><td>来源渠道 </td>				
			</tr>
			<tr>
			    <td><input class="checkeds" checked="checked" type="checkbox" name="sourceUrl" onclick="checkOrClose(this)" /></td><td>来源网址 </td>
				<td><input class="checkeds" checked="checked" type="checkbox" name="sourceKeyWord" onclick="checkOrClose(this)" /></td><td>来源关键字 </td>
				<td><input class="checkeds" checked="checked" type="checkbox" name="address" onclick="checkOrClose(this)" /></td><td>学生地址</td>
				<td><input class="checkeds" checked="checked" type="checkbox" name="qq" onclick="checkOrClose(this)" /></td><td>qq号</td>
				
			</tr>
			<tr>
			    <td><input class="checkeds" checked="checked" type="checkbox" name="weiXin" onclick="checkOrClose(this)" /></td><td>微信号</td>			
				<td><input class="checkeds" checked="checked" type="checkbox" name="content" onclick="checkOrClose(this)" /></td><td>备注</td>
				<td><input class="checkeds" checked="checked" type="checkbox" name="creatTimes" onclick="checkOrClose(this)" /></td><td>创建时间</td>
				<td><input class="checkeds" checked="checked" type="checkbox" name="learnForword" onclick="checkOrClose(this)" /></td><td>课程方向	</td>																
		</tr>
		<tr>
		        <td><input class="checkeds" checked="checked" type="checkbox" name="isValid" onclick="checkOrClose(this)" /></td><td>是否有效	</td>												
				<td><input class="checkeds" checked="checked" type="checkbox" name="isReturnVisit" onclick="checkOrClose(this)" /></td><td>回访情况</td>
				<td><input class="checkeds" checked="checked" type="checkbox" name="firstVisitTime" onclick="checkOrClose(this)" /></td><td>第一次回访时间</td>
				<td><input class="checkeds" checked="checked" type="checkbox" name="isHome" onclick="checkOrClose(this)" /></td><td>是否家访</td>		
				
		</tr>
		<tr>
		        <td><input class="checkeds" checked="checked" type="checkbox" name="homeTime" onclick="checkOrClose(this)" /></td><td>家访时间</td>												
				<td><input class="checkeds" checked="checked" type="checkbox" name="lostValid" onclick="checkOrClose(this)" /></td><td>无效原因</td>
				<td><input class="checkeds" checked="checked" type="checkbox" name="isPay" onclick="checkOrClose(this)" /></td><td>是否缴费</td>
				<td><input class="checkeds" checked="checked" type="checkbox" name="payTime" onclick="checkOrClose(this)" /></td><td>缴费时间</td>		
				
		</tr>
		<tr>
		        <td><input class="checkeds" checked="checked" type="checkbox" name="money" onclick="checkOrClose(this)" /></td><td>缴费金额	</td>												
				<td><input class="checkeds" checked="checked" type="checkbox" name="isReturnMoney" onclick="checkOrClose(this)" /></td><td>是否退费</td>
				<td><input class="checkeds" checked="checked" type="checkbox" name="isInClass" onclick="checkOrClose(this)" /></td><td>是否进班</td>
				<td><input class="checkeds" checked="checked" type="checkbox" name="inClassTime" onclick="checkOrClose(this)" /></td><td>进班时间</td>		
				
		</tr>
		<tr>
		        <td><input class="checkeds" checked="checked" type="checkbox" name="inClassContent" onclick="checkOrClose(this)" /></td><td>进班备注</td>												
				<td><input class="checkeds" checked="checked" type="checkbox" name="askerContent" onclick="checkOrClose(this)" /></td><td>咨询师备注</td>
				<td><input class="checkeds" checked="checked" type="checkbox" name="stuConcern" onclick="checkOrClose(this)" /></td><td>学生担忧情况</td>
				<td><input class="checkeds" checked="checked" type="checkbox" name="isBaoBei" onclick="checkOrClose(this)" /></td><td>是否报备</td>			
		</tr>
		<tr>
		        <td><input class="checkeds" checked="checked" type="checkbox" name="ziXunName" onclick="checkOrClose(this)" /></td><td>咨询内容</td>												
				<td><input class="checkeds" checked="checked" type="checkbox" name="returnMoneyReason" onclick="checkOrClose(this)" /></td><td>退费原因</td>
				<td><input class="checkeds" checked="checked" type="checkbox" name="preMoney" onclick="checkOrClose(this)" /></td><td>定金金额</td>
				<td><input class="checkeds" checked="checked" type="checkbox" name="preMoneyTime" onclick="checkOrClose(this)" /></td><td>交定金时间</td>			
		</tr>
		<tr>
		        <td><input class="checkeds" checked="checked" type="checkbox" name="askerId" onclick="checkOrClose(this)" /></td><td>咨询师编号</td>												
	...
	<div id="addWindow" class="easyui-window"
		data-options="closed:true,title:'添加表单'">
		<form id="addForm">
			<table>
				...
				<tr>
					...
					<td><input class="easyui-validatebox" type="text" id="addAge" data-options="required:true" placeholder="请输入年龄"/>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><select id="addStuStatus" class="easyui-combobox">
							<option>--请选择--</option>
							<option>未知</option>
							<option>大专</option>
							<option>高中</option>
				...
				<tr>
					...
					<td><select id="addPerStatus" class="easyui-combobox">
							<option>--请选择--</option>
							<option>未知</option>
							<option>待业</option>
							<option>在职</option>
				...
				<tr>
					...
					<td><select id="addMsgSource" class="easyui-combobox">
							<option>--请选择--</option>
							<option>未知</option>
							<option>百度</option>
							<option>百度移动端</option>
				...
				<tr>
					...
					<td><select id="addSourceUrl" class="easyui-combobox">
							<option>--请选择--</option>
							<option>其它</option>
							<option>职英B站</option>
							<option>职英A站</option>
				...
				<td> <select id="addIsValid" class="easyui-combobox">
						<option value="">--请选择--</option>
						<option>是</option>
						<option>否</option>
				      </select>
				...
				<tr>
					...
					<td><input class="easyui-validatebox" type="text"
						id="addSourceKeyWord" data-options="required:true" placeholder="请输入来源关键字"/></td>
				</tr>
				<tr>
					<td><label for="name">学员QQ:</label></td>
					<td><input class="easyui-validatebox" type="text" id="addQQ" data-options="required:true" placeholder="请输入学院QQ"/>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><select id="AddisReturnVisit" class="easyui-combobox">
							<option value=''>--请选择--</option>
							<option>已回访</option>
							<option>未回访</option>
							<option>思量</option>
	...
	<div id="updateWindow" class="easyui-window"
		...
		<form id="updateForm">
			<table>
				...
				<tr>
				<td><label for="name">是否有效： </label></td>
				<td><select id="isValid" class="easyui-combobox" disabled="disabled">
						<option value=''>--请选择--</option>
						<option>是</option>
						<option>否</option>
				</select></td>
				...
				<tr>
					...
					<td><input class="easyui-validatebox" type="text"
						id="updateinClassContent" name="inClassContent" disabled="disabled"/></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input class="easyui-validatebox" type="text"
						id="updateReturnMoneyReason" name="returnMoneyReason" disabled="disabled"/></td>
				</tr>
				<tr>
	...
	<div id="genzongid" class="easyui-window"
		...
		<form id="genzongForm" class="easyui-form">
			<table>
				...
				<tr>
					<td><input type="hidden" id="LoginUserName" value="${LoginUserName}"></td>
				</tr>
				...
				<tr>
					<td>跟踪状态:</td>
					<td>
					<select id="n_qingkuang" class="easyui-combobox">
							<option value=''>--请选择--</option>
							<option>已跟踪</option>
							<option>跟踪中</option>
							<option>思量</option>
